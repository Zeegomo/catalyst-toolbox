...
impl CheckNode {
    pub fn spawn(storage: PathBuf, genesis_block_hash: String) -> Result<Self, Error> {
        // FIXME: we are using test tools which are not always super respectful of keeping
        // stdout clean of unwanted output.
        // This redirects stdout to null untils it's dropped
    ...
    pub fn check_transactions_on_chain(&self, transactions: Vec<String>) -> Result<(), Error> {
        ...
        // returns all the blocks in the main branch
